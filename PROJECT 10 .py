class ArtGallery:
    def __init__(self, gallery_name, location):
        ...
        print(f"\nWelcome to {self.gallery_name} 🖼️🎨 (❁´◡`❁)!")
    ...
    # Destructor
    def __del__(self):
        print(f"\nClosing {self.gallery_name}. Thank you for managing the art collection! 😀✨❤️")
...
while True:
    print("\n========= ART GALLERY MENU =========")
    print("1. Add Artwork 📢➕")
    print("2. Remove Artwork ®️📢")
    print("3. Display Art Collection 📢🖼️")
    print("4. Exit =)")
    print("===================================")
